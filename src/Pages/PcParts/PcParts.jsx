...
function UsedPc() {
    ...
    useEffect(() => {
        axios.get("http://localhost:5000/products?section=PcParts&status=active").then((res) => {
            if (search) {
            ...
            if (filter) {
                ...
                if (filter.gigabyte) activeKeywords.push('gigabyte');
                if (filter.eightram) activeKeywords.push('8gb gdd');
                if (filter.onesixram) activeKeywords.push('16gb gdd');
                if (filter.twofourram) activeKeywords.push('24gb gdd');
                if (filter.threetworam) activeKeywords.push('32gb gdd');
    ...
    return (
        <>
            <SearchBar type={"Pc Parts"} callback={searchresults} />
                ...
                <div className="left">
                    ...
                    <div className="filter">
                        ...
                        <div className="filterbox">
                            ...
                            <h4>GigaByte <input type="checkbox" name="check" id="check" value={filter.gigabyte} onChange={() => setFilter({ ...filter, gigabyte: !filter.gigabyte })} /></h4>
                        </div>
                        <div className="filterbox">
                            <h3>VRam</h3>
